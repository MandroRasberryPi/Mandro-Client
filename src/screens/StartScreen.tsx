  ...
  return (
    <View className="flex-1 bg-white flex-row px-6 pt-10">
      <View className="w-[40%] pr-4">
        ...
        <Text className="text-primary font-pretendard font-bold text-xl mb-1">
          Eye{'\n'}Distance
        </Text>
        <CustomSlider value={eyeDistance} onValueChange={setEyeDistance} />

        <Text className="text-primary font-pretendard font-bold text-xl mt-6 mb-1">
          Distorted
        </Text>
        <CustomSlider value={distorted} onValueChange={setDistorted} />

        <Text className="text-primary font-pretendard font-bold text-xl mt-6 mb-2">
          IP Address
        </Text>
        <TextInput
          value={ip}
      ...
      <View className="w-[60%] flex-row justify-between">
        <View className="w-[48%] h-96 bg-gray-300 rounded-md justify-center items-center">
          <Text className="text-gray-500 font-pretendard">Camera View 1</Text>
        </View>
        <View className="w-[48%] h-96 bg-gray-300 rounded-md justify-center items-center">
          <Text className="text-gray-500 font-pretendard">Camera View 2</Text>
        </View>
      </View>
    </View>
  );
